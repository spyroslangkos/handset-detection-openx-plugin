...
class Plugins_InvocationTags_OxInvocationTags_adview extends Plugins_InvocationTags
{
  ...
  * <img> tag."),
	...
	// $newImage = "<a href='http://localhost/www/delivery/ck.php?n=ab6525f6&amp;cb=INSERT_RANDOM_NUMBER_HERE' target='_blank'><img src='http://localhost/www/delivery/avw.php?zoneid=3&amp;cb=INSERT_RANDOM_NUMBER_HERE&amp;n=ab6525f6' border='0' alt='' /></a>";
	$zoneid = $mi->zoneid;
	$newImage = "<a href='http://$host/www/delivery/ck.php?n=ab6525f6&amp;cb=INSERT_RANDOM_NUMBER_HERE' target='_blank'><img src='http://$filepath?zoneid=$zoneid&amp;indicator=$userid&amp;phpfile=avw.php&amp;cb=INSERT_RANDOM_NUMBER_HERE&amp;n=ab6525f6' border='0' alt='' /></a>";
        $buffer .= $newImage;
