...
class Plugins_InvocationTags_OxInvocationTags_adjs extends Plugins_InvocationTags
{
  ...
  * users."),
	...
	$newURL = dirname(dirname(dirname(MAX_commonConstructPartialDeliveryUrl($conf['file']['js'], true)))). "/plugins/invocationTags/oxInvocationTags/handset.php";
	$buffer .= "   var m3_u = (location.protocol=='https:'?'https:". $newURL."':'http:".$newURL."');\n";
	...
	$userid = OA_Permission::getUserId();
        $buffer .= "   document.write ('&amp;indicator=$userid');\n";
        $buffer .= "   document.write ('&amp;phpfile=ajs.php');\n";
