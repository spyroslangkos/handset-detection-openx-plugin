...
+---------------------------------------------------------------------------+
$Id: campaign-banners.php 34688 2009-04-01 16:18:28Z andrew.hill $
*/
...
$oTpl = new OA_Plugin_Template('mobile-banner-index.html');
...
$MP = '/www/admin/';
    ...
    if (!OA_Permission::isAccount(OA_ACCOUNT_ADVERTISER)) {
        $campaignEditUrl = $MP. "campaign-edit.php?clientid=$advertiserId&campaignid=$campaignId";
    }
...
function getAdvertiserMap()
{
    ...
    while ($doClients->fetch() && $row = $doClients->toArray()) {
        $aAdvertiserMap[$row['clientid']] = array('name' => $row['clientname'],
            'url' => $MP. "advertiser-campaigns.php?clientid=".$row['clientid']);
    }
